...
try:
    image_bolo = Image.open("../imagens/1.jpeg")  # Nome do arquivo corrigido
    st.image(image_bolo, caption="Um bolo especial!", use_container_width=True)
except FileNotFoundError:
    st.error("Erro: A imagem '../imagens/1.jpeg' não foi encontrada na pasta 'Imagens'.")
...
try:
    image_festa1 = Image.open("../imagens/2.jpeg")  # Nome do arquivo corrigido
    cols[0].image(image_festa1, caption="Celebrando!", use_container_width=True)
except FileNotFoundError:
    cols[0].error("Imagem '../imagens/2.jpeg' não encontrada.")

try:
    image_festa2 = Image.open("../imagens/3.jpeg")  # Nome do arquivo corrigido
    cols[1].image(image_festa2, caption="Mais festa!", use_container_width=True)
except FileNotFoundError:
    cols[1].error("Imagem '../imagens/3.jpeg' não encontrada.")
